...
use micro\models\PaymentOrdersSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * PaymentordersviewController implements the CRUD actions for PaymentOrders model.
 */
class PaymentordersviewController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Displays a single PaymentOrders model.
     * @param integer $id
     * @return mixed
